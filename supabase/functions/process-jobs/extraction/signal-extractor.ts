...
import type { YmmeIndex } from "./ymme-index.ts"
import type { YmmeIndexMake, YmmeIndexModel, YmmeIndexEngine } from "./ymme-index.ts"
import { scanTextForVehicles, type VehicleMention } from "./ymme-scanner.ts"
import { extractEngineHints, ENGINE_CODE_PATTERNS } from "./engine-format.ts"
