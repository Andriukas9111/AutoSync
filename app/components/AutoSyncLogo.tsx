/**
 * Official AutoSync brand logo — derived from AutosyncIcoSVG.svg
 * Use this component everywhere the brand icon is needed.
 */
export function AutoSyncLogo({ size = 24 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
