...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const [
    ...
    db.from("tenants").select("shop_id, shop_domain, plan, plan_status, product_count, fitment_count, installed_at, uninstalled_at, online_store_publication_id").order("installed_at", { ascending: false }).limit(500),
